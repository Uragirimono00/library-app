...
class BookServiceTest @Autowired constructor(
  ...
  fun countLoanBookTest() {
    // given
    val savedUser = userRepository.save(User("형서", null))
  ...
  fun getBookStatisticsTest() {
    ...
    bookRepository.saveAll(
      listOf(
        Book.fixture("A", BookEnums.COMPUTER),
        Book.fixture("B", BookEnums.COMPUTER),
        Book.fixture("C", BookEnums.SCIENCE),
      )
    )
    ...
    assertCount(results, BookEnums.COMPUTER, 2L)
    assertCount(results, BookEnums.SCIENCE, 1L)
  }

  private fun assertCount(results: List<BookStatResponse>, type: BookEnums, count: Long) {
